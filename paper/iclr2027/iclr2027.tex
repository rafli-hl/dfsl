...
tracker (\cref{sec:tracker}), not of predictability. \emph{(ii) The cap:} a
...
standardization, per-row). The cap family: OGD (scale-dependent) against the $M\!\to\!0$
...
the scale-invariant methods climb to $R^2\approx0.2$--$0.3$ with overlapping intervals
