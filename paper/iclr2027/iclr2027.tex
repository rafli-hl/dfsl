...
leaves it fragile; SN-OMD is essentially unchanged ($0.285\to0.307$), so its accuracy is not a
contemporaneous-information artifact, whereas uncapped scale-adaptive OGD \emph{halves}
($0.159\to0.080$: aggregating enlarges the untruncated step a finite cap would contain).
...
Scale-adaptive OGD ($M\!\to\!\infty$)  & --- & $7/10$ & $0.09\pm.02$ & $0/10$ \\
...
\textbf{SN-OMD ($M{=}5$, ours)}        & $0.14\pm.11$ & $0/10$ & $0.12\pm.15$ & $0/10$ \\
