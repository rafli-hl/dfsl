...
\begin{itemize}
  ...
  (\cref{sec:method,sec:msweep}). SN-OMD divides by the tracked scale and caps at a
  ...
  per-row vs.\ per-timestep updates (no contemporaneous leakage), and the advantage vanishes on
...
The \emph{scale-invariant} family---normalized-GD, SN-OMD, uncapped
...
\emph{(ii) The cap.} A finite $M$ bounds the step directly, but non-divergence is \emph{not} unique to it---
