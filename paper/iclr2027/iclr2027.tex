...
$\{0.5,1,2,5,10\}$ median scales, $N$ grows with exponent $1.16$--$1.24$ in $T$. We apply
...
\emph{at least linear}. It agrees with \cref{tab:beta}'s independently measured
$\beta\approx1.0$--$1.25$ for $W_s$, which is the coherence check one wants: regimes and upward
variation accumulate at the same rate.
