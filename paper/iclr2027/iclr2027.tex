...
that experiment's own optimum, not a duplicated or stale row. Interpretation of
\cref{tab:jane}, and the block-median tracker variant, are in
\cref{sec:experiments,sec:tracker}.
