...
remain: our evidence is one (large) market dataset (a second, non-finance domain would
substantiate the generality claim); our baselines omit the Adam family of coordinate-wise
adaptive optimizers (\cref{sec:related}); and evaluation centers on accuracy and stability
rather than mechanism-level diagnostics. Open directions include per-coordinate
normalization and tighter dynamic constants.
...
\begin{figure}[t]
\centering
\includegraphics[width=0.9\columnwidth]{fig5_synthetic.png}
