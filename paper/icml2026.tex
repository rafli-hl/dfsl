...
Normalized-GD ($M\!\to\!0$)          & $0.197$ & $0.316$ & $\le 2$ \\
Scale-adaptive OGD ($M\!\to\!\infty$)& $0.162$ & $0.080$ & $\le 1$ \\
Fixed-$\tau$ clip (const $M$)        & $0.246$ & $\mathbf{0.382}$ & $\le 0.2$ \\
AdaGrad-Norm                         & $\mathbf{0.329}$ & $0.219$ & $\le 10$ \\
\textbf{SN-OMD ($M{=}5$, ours)}      & $0.285$ & $0.309$ & $\le 2$ \\
\bottomrule
\end{tabular}
\end{small}
\end{table}
