...
\begin{itemize}
  ...
  paper's central finding; our one non-market check shows only \emph{schedule-driven}
  heaviness (\cref{app:mnist}).
...
domains is warranted. Finally, the normalized residual tail is dominated by
