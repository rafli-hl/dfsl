...
partition. Sweeping the rate, OGD's peak loss explodes above $\mathrm{lr}\!\approx\!0.05$ while
the bounded methods stay single-digit to $\mathrm{lr}{=}8$, and the cap is decisive---at
$\mathrm{lr}{=}8$ SN-OMD ($M{=}5$) holds a peak loss of $13$ where the uncapped endpoint reaches
$3{\times}10^{17}$.
